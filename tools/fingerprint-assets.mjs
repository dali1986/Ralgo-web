...
export async function fingerprintAssets(root){
  ...
  for(const file of ['routes.js','share-card-paths.js','collection-meta.js','works.js','artwork-thumbnails.js','art-home.js','analytics.js','app.js'])await version(file,true);
